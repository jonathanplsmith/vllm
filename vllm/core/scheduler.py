...
class Scheduler:
    ...
    def _preempt_by_recompute(
        ...
        seq_group.add_preempty_out_time(time.time(), -1)
    ...
    def _preempt_by_swap(
        ...
        seq_group.add_preempty_out_time(time.time(), len(blocks_to_swap_out))
    ...
    def _swap_in(
        ...
        seq_group.add_preempty_in_time(time.time(), len(blocks_to_swap_in))
